...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO blast (nomor,pesan,media,jadwal,make_by) VALUES (?,?,?,?,?)");

        if($stmt->execute([ $nomor,$pesan,$media,$jadwal,$make_by  ])) {
                $stmt = null;
                header("location: blast-index.php");
            } else{

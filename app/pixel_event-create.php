...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO pixel_event (name,created_at,updated_at,deleted_at) VALUES (?,?,?,?)");

        if($stmt->execute([ $name,$created_at,$updated_at,$deleted_at  ])) {
                $stmt = null;
                header("location: pixel_event-index.php");
            } else{
